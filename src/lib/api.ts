...
const courses: Course[] = [
  {
    ...
    curriculum: [
      ...
      {
        id: "m4",
        title: "Hugging Face Ecosystem & Fine-Tuning ",
        duration: "24 hrs",
        topics: [
  ...
  },
  {
    ...
    metaData: {
      ...
      description: "Data Science with IIT faculty. Python, SQL, ML, AI, Tableau. Pay After Placement. 37,500 students enrolled. 4.8★ rating. Placements at Amazon, IBM. Apply now!",
      bio: "Data Science with IIT faculty. Python, SQL, ML, AI, Tableau. Pay After Placement. 37,500 students enrolled. 4.8★ rating. Placements at Amazon, IBM. Apply now!"
  ...
  },
  {
    ...
    curriculum: [
      ...
      ,
      {
        ...
        // ]
        topics: [
          { "id": "t1", "title": "Foundations of Artificial Intelligence, Machine Learning & Generative AI", "duration": "" },
          { "id": "t2", "title": "Understanding Large Language Models (LLMs) and how tools like ChatGPT work", "duration": "" },
          { "id": "t3", "title": "Prompt Engineering for effective AI interactions and content generation", "duration": "" },
          { "id": "t4", "title": "AI-powered research, summarization and knowledge management", "duration": "" },
          { "id": "t5", "title": "Creating text, presentations, reports and professional documents using AI", "duration": "" },
          { "id": "t6", "title": "Image generation and visual content creation with Generative AI tools", "duration": "" },
          { "id": "t7", "title": "AI for productivity, workplace automation and task optimization", "duration": "" },
          { "id": "t8", "title": "Building custom AI assistants and no-code AI applications", "duration": "" },
          { "id": "t9", "title": "AI for data analysis, insights generation and decision support", "duration": "" },
          { "id": "t10", "title": "Responsible AI, ethics, privacy and best practices", "duration": "" }
        ]
...

  {
    ...
    isFeatured: true,
    metaData: {
      title: "Pay After Placement Data Science Course | Ivy Pro School",
      description: "Start your data science career with zero upfront fees. Learn Python, ML, AI & analytics through real projects and expert mentorship. Pay only after you get placed in top data roles.",
      bio: "Start your data science career with zero upfront fees. Learn Python, ML, AI & analytics through real projects and expert mentorship. Pay only after you get placed in top data roles."
    ...
    curriculum: [
      ...
      },
      {
        ...
        "topics": [
          ...
          { "id": "p1", "title": "Project: Image Classification Model (CNN for object/digit recognition)", "duration": "3 hrs" },
          { "id": "p2", "title": "Project: Sentiment Analysis Engine (NLP for emotion classification)", "duration": "3 hrs" },
          { "id": "p3", "title": "Project: Stock Price Prediction (LSTM for time-series forecasting)", "duration": "3 hrs" }
        ]
      }
...

  {
    ...
    metaData: {
      title: "Data Engineering Course in Bangalore with placement support | Ivy Professional School",
      description: "Build a job-ready data engineering career in Bangalore. Learn scalable pipelines, big data tools, and real-world skills used by top tech companies.",
...

  {
    ...
    students: 1243,
    metaData: {
      title: "Data Science Course in Chennai with Placement Support | Ivy Pro School",
      description: "Learn data science in Chennai with Ivy Professional School. Master analytics, machine learning, and AI through real-world projects, expert mentorship, and career-focused training. Build job-ready skills for top roles in IT, fintech, and analytics.",
      bio: "Looking to build a high-growth career in analytics, Machine Learning, and Artificial Intelligence? The Data Science Course in Kolkata by Ivy Professional School is designed to help students and working professionals master industry-relevant data science skills with hands-on projects, expert faculty, and career-focused training.\n\n Kolkata is fast emerging as a technology and analytics hub, and our Data Science program equips you with practical knowledge, real-world exposure, and placement assistance to compete in top data-driven roles across India."
...

  {
    ...
    students: 1243,
    metaData: {
      title: "Data Science Course in Bangalore with Placement | Ivy Professional School",
      description: "Job-ready Data Science course in Bangalore with ML & GenAI. Learn Excel, SQL, Python through projects, build a portfolio, and get placement support.",
      bio: "Looking to build a high-growth career in analytics, Machine Learning, and Artificial Intelligence? The Data Science Course in Kolkata by Ivy Professional School is designed to help students and working professionals master industry-relevant data science skills with hands-on projects, expert faculty, and career-focused training.\n\n Kolkata is fast emerging as a technology and analytics hub, and our Data Science program equips you with practical knowledge, real-world exposure, and placement assistance to compete in top data-driven roles across India."
  ...
  },
  {
    ...
    students: 5876,
    metaData: {
      title: "Generative AI Course in Delhi with Placement Support | Ivy Professional School",
  ...
  },
  {
    ...
    reviewCount: 5567,
    isFeatured: true,
    slug: "generative-ai-course-mumbai",
    longDescription: " The Generative AI Course in Mumbai by Ivy Professional School is an advanced training program designed to help learners gain practical, job‑ready expertise in generative artificial intelligence. Through a blend of theoretical instruction and hands‑on projects, you will develop the technical foundation and creative problem‑solving skills needed to build generative models that power applications in content creation, automation, simulation, personalization, and more. \n\n Mumbai’s thriving technology and business ecosystem make it an ideal location for upskilling. Whether you are seeking a new career path or aiming to advance in your current role, this course will prepare you with industry‑aligned knowledge and practical experience."
    , outcomes: [
      "Understand core concepts of artificial intelligence, machine learning, and deep learning.",
      "Develop proficiency in Python as the primary language for AI development.",
      "Build and train Generative Adversarial Networks (GANs) for image synthesis and creative AI applications.",
      "Implement Variational Autoencoders (VAEs) for data representation and generation.",
      "Use TensorFlow and PyTorch to implement neural networks.",
      "Work with Scikit‑Learn for classical machine learning tasks.",
      "Create text generation, image creation, and AI automation projects.",
      "Learn how to deploy AI models using cloud platforms such as AWS, Azure, and Google Cloud."
    ],
    prerequisites: [
      "Familiarity with basic digital tools and online platforms.",
      "Understanding of high-school level algebra and statistics.",
  ...
  },
  {
    ...
    reviewCount: 5567,
    isFeatured: true,
    slug: "generative-ai-course-pune",
    longDescription: " The Generative AI Course in Pune is a comprehensive program aimed at equipping you with both theoretical knowledge and practical skills in generative AI. You’ll learn how to design and implement generative models for tasks like text generation, image synthesis, and automation. \n\n Through hands-on experience, you will gain proficiency in the latest AI tools and frameworks, preparing you to apply your skills in industries ranging from content creation to personalized AI solutions. \n\n Pune, with its growing tech industry and startup culture, provides the perfect environment for learning and growing your AI expertise."
    , outcomes: [
      "Understand the core concepts of AI, deep learning, and machine learning.",
      "Learn Python and its libraries for AI development.",
      "Gain expertise in building Generative Adversarial Networks (GANs) for tasks like image synthesis and creative AI applications.",
      "Learn how to implement Variational Autoencoders (VAEs) for efficient data representation and generation.",
      "Work with powerful tools like TensorFlow, PyTorch, and Hugging Face Transformers.",
      "Gain hands-on experience with Scikit-Learn for traditional machine learning tasks.",
      "Create AI projects focused on text generation, image creation, and AI-powered automation.",
      "Learn to deploy and integrate AI models on cloud service"
    ],
    prerequisites: [
      "Familiarity with basic digital tools and online platforms.",
      "Understanding of high-school level algebra and statistics.",
...

  {
    ...
    reviewCount: 5567,
    isFeatured: true,
    slug: "generative-ai-course-chennai",
    longDescription: " This Generative AI Course is designed to provide an in-depth understanding of AI-driven content generation. Through a combination of theoretical insights and practical projects, you will learn to build and implement AI models used in content creation, automation, and more. With hands-on experience using the latest tools and technologies, you will be prepared to apply your skills in real-world scenarios, whether you're transitioning to a new career or advancing in your current one. \n\n Chennai, a center for innovation and technology, is the ideal place to gain expertise in this rapidly evolving field."
    , outcomes: [
      "Gain a solid understanding of AI, deep learning, and machine learning fundamentals.",
      "Learn to work with Python and implement machine learning algorithms.",
      "Explore Variational Autoencoders (VAEs) for effective data generation and representation.",
      "Use TensorFlow and PyTorch for implementing and deploying models.",
  ...
  {
    id: '24',
    title: "Data Analytics With Visualization in Chennai",
    description: "  Start your journey in analytics with Ivy Professional School’s Chennai-based program. Learn industry-relevant tools and techniques, build real projects, and gain job-focused training to thrive in data roles.",
    image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    category: "Deep Learning",
    students: 1243,
    metaData: {
      title: "Data Analytics Training in Chennai + Placement Support | Ivy Professional School",
      description: "Join Ivy Professional School’s Data Analytics With Visualization in Chennai - Learn top tools with hands-on projects & career support.",
      bio: "Learn to analyze and visualize data, work on industry projects, earn a prestigious certificate, and become a job-ready data analyst within 12-14 months."
    ...
    longDescription: "Ivy Professional School’s Data Analytics Course in Chennai is crafted to help aspiring analysts and professionals build a strong foundation in data interpretation, business intelligence, and analytical modeling. \n\n With Chennai emerging as a major hub for IT, finance, and consulting, the need for skilled data analysts continues to grow. Our course combines foundational learning with advanced practical exposure to ensure you're ready for real-world challenges. \n\n The course emphasizes hands-on experience by covering Python for data transformation and automation, SQL for extracting insights from structured databases, Excel for applied business analytics, Tableau and Power BI for dashboarding and visualization, and statistics and predictive modelling for data-driven decision-making."
    , instructors: [
      {
        id: "i1",
        name: "Prateek Agrawal",
