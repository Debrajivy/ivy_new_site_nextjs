...
const ContactPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Ivy Professional School</title>
        <meta 
          name="description" 
          content="Get in touch with Ivy Professional School. We'd love to hear from you and answer any questions about our courses and programs." 
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="mt-8 p-6 bg-gray-50 rounded-lg">
                  ...
                  <p className="mb-4">
                    Experience our teaching methodology firsthand. Register for two free trial classes and explore our learning environment.
                  </p>
                  <Button className="bg-ivy-blue">
