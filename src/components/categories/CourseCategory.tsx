...
import { Users, Clock, Star, Filter, SlidersHorizontal } from 'lucide-react';
...
const allCourses: Course[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1649180556628-9ba704115795?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
    category: "Data Science",
    students: 3210,
    duration: "8 weeks",
    rating: 4.6,
...
const CourseCategory = () => {
  ...
  ) || { name: "All Courses", description: "Browse our complete catalog of data science and AI courses" };

  // Filter courses based on category and selected level
  const filteredCourses = allCourses.filter(course => {
    const categoryMatch = !slug || slug === 'all' || 
      course.category.toLowerCase().replace(/\s+/g, '-') === slug;
    
    const levelMatch = selectedLevel.length === 0 || 
            ...
            <div className="md:hidden bg-white p-4 rounded-lg shadow-sm mb-6">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge 
                    variant={!slug || slug === 'all' ? "default" : "outline"}
              ...
              filteredCourses.map((course) => (
                <Card key={course.id} className="card-hover h-full flex flex-col">
                  <div className="relative">
                    ...
                    {course.isFeatured && (
                      <Badge className="absolute top-3 right-3 badge-featured">Featured</Badge>
                    )}
                  </div>
