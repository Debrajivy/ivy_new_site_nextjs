...
const IVY_COURSES: Course[] = [
  ...
  {
    id: 'cloud-de-cert',
    name: 'Cloud Data Engineering Certification',
  ...
  {
    id: 'ds-ml-ai',
    name: 'Data Science with Machine Learning & AI',
  ...
  },
  {
    ...
    name: 'Data Analytics with Visualization Certification Course',
  ...
  },
  {
    ...
    name: 'Business Analytics Certification Course',
