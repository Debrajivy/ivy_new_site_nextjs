      ...
      <CardContent className="p-6 space-y-4">
        ...
        `,
                    ...
                    <p style={{ fontSize: '14px', lineHeight: '1.6', margin: 0, textShadow: '1px 1px 1px rgba(135, 206, 235, 0.2)' }}>
                      {course.title === " Advanced Generative AI Course" || course.title === "Advanced Generative AI Course in Kolkata" || course.title === "Advanced Generative AI Course in Delhi" || course.title === "Advanced Generative AI Course in Pune" || course.title === "Advanced Generative AI Course in Chennai" || course.title === "Advanced Generative AI Course in Bangalore" || course.title === "Advanced Generative AI Course in Mumbai" ?
