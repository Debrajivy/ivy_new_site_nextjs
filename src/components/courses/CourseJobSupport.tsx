      ...
      <CardContent className="p-6 space-y-4">
        ...
        `,
                    ...
                    <p style={{ fontSize: '14px', lineHeight: '1.6', margin: 0, textShadow: '1px 1px 1px rgba(135, 206, 235, 0.2)' }}>
                      {course.title === " Advanced Generative AI Course" || course.title === "Generative AI Course in Kolkata" || course.title === "Generative AI Course in Delhi" || course.title === "Generative AI Course in Pune" || course.title === "Generative AI Course in Chennai" || course.title === "Generative AI Course in Bangalore" || course.title === "Generative AI Course in Mumbai" ?
                        "The Executive Certification in GenAI ensures quality and comprehensiveness of content coverage as well as ample credibility in the Gen AI field." :
                                    ...
                                    course.title === "Data Engineering Course in Pune" ?
                                      ...
                                      course.title === "Data Engineering Course in Chennai" ?
                                        ...
                                        course.title === "Data Analytics and Generative AI Course" ?
                                          "Earn Ivy’s Data Science with Visualization certificate and prove your command over Excel, SQL, Python, Power BI. Backed by 1:1 mentoring, this certification blends dashboarding, predictive modeling & automation into job-ready expertise." :
                                          course.title === "Data Analytics With Visualization" || course.title === "Data Analytics With Visualization in Kolkata" || course.title === "Data Analytics With Visualization in Delhi" || course.title === "Data Analytics With Visualization in Bangalore" || course.title === "Data Analytics With Visualization in Mumbai" || course.title === "Data Analytics With Visualization in Pune"  || course.title === "Data Analytics With Visualization in Chennai" ?
        ...
        `,
                    ...
                    <p style={{ fontSize: '14px', lineHeight: '1.6', margin: 0 }}>
                      {(course.title === " Advanced Generative AI Course" || course.title === "Data Science with Machine Learning & AI Certification") ?
