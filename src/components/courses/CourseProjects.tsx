...

          {
            course.title === "Data Science with Machine Learning & AI Certification" || course.title === "Data Science with Machine Learning & AI Course in Kolkata" || course.title === "Data Science with Machine Learning & AI Course in Delhi" || course.title === "Data Science with Machine Learning & AI Course in Bangalore" || course.title === "Data Science with Machine Learning & AI Course in Mumbai" || course.title === "Data Science with Machine Learning & AI Course in Pune" || course.title === "Data Science with Machine Learning & AI Course in Chennai" ?
              ...
              course.title === "Data Science with Machine Learning & AI Certification" ?
                ...
                course.title === "Generative AI Course" || course.title === "Generative AI Course in Kolkata"  || course.title === "Generative AI Course in Delhi" || course.title === "Generative AI Course in Bangalore"  || course.title === "Generative AI Course in Mumbai" || course.title === "Generative AI Course in Pune" ||  course.title === "Generative AI Course in Chennai"?
                  ...
                  course.title === "Data Analytics and Generative AI Course" ?
                    ...
                    course.title === "Data Analytics With Visualization" || course.title === "Data Analytics With Visualization in Kolkata" || course.title === "Data Analytics With Visualization in Delhi"  || course.title === "Data Analytics With Visualization in Bangalore" || course.title === "Data Analytics With Visualization in Mumbai" ?
                      ...
                      course.title === "Data Analytics and Generative AI Course" ?
                        ...
                        :
                        course.title === " Data Engineering Course" || course.title === "Cloud Data Engineering Course with IIT Guwahati" || course.title === "Data Engineering Course in Kolkata" || course.title === "Data Engineering Course in Mumbai" || course.title === "Data Engineering Course in Pune" || course.title === "Data Engineering Course in Delhi" || course.title === "Data Engineering Course in Bangalore" || course.title === "Data Engineering Course in Chennai" ?
                          <TabsContent value="capstone">
                            <div className="mb-8">
                              <div className="flex flex-col sm:flex-row sm:items-center mb-4 gap-2 sm:gap-0">
                                <h3 className="text-2xl font-bold">Industry Capstone Projects</h3>
